        ...
        <div className="mt-3">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="grid w-full grid-cols-2">
              <TabsTrigger value="default">{t('slashCommands.tabs.default')}</TabsTrigger>
              <TabsTrigger value="custom">{t('slashCommands.tabs.custom')}</TabsTrigger>
            </TabsList>
          </Tabs>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto relative">
        {isLoading && (
          <div className="flex items-center justify-center h-full">
            <span className="text-sm text-muted-foreground">{t('slashCommands.loading')}</span>
          </div>
        )}
