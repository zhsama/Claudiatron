...
export const ClaudeIcon: React.FC<ClaudeIconProps> = ({ 
  ...
  return (
    <div className={`inline-block ${className}`} style={{ position: 'relative', width: size, height: size }}>
      <svg 
        overflow="visible" 
        width="100%" 
        height="100%" 
      ...
      >
        ...
        <path 
          ...
          fill="#D97757" 
          style={!animated ? {transformOrigin: '50px 50px', transform: 'rotate(330deg) scaleY(1.39846) rotate(-330deg)'} : {}}
        />
        <path 
          className={animated ? "claude-line" : ""} 
          ...
          fill="#D97757" 
          style={!animated ? {transformOrigin: '50px 50px', transform: 'rotate(300deg) scaleY(1.39867) rotate(-300deg)'} : {}}
        />
        <path 
          className={animated ? "claude-line" : ""} 
          ...
          fill="#D97757" 
          style={!animated ? {transformOrigin: '50px 50px', transform: 'rotate(270deg) scaleY(1.3984) rotate(-270deg)'} : {}}
        />
        <path 
          className={animated ? "claude-line" : ""} 
          ...
          fill="#D97757" 
          style={!animated ? {transformOrigin: '50px 50px', transform: 'rotate(240deg) scaleY(1.39889) rotate(-240deg)'} : {}}
        />
        <path 
          className={animated ? "claude-line" : ""} 
          ...
          fill="#D97757" 
          style={!animated ? {transformOrigin: '50px 50px', transform: 'rotate(210deg) scaleY(1.39835) rotate(-210deg)'} : {}}
        />
        <path 
          className={animated ? "claude-line" : ""} 
          ...
          fill="#D97757" 
          style={!animated ? {transformOrigin: '50px 50px', transform: 'rotate(180deg) scaleY(1.39893) rotate(-180deg)'} : {}}
        />
        <path 
          className={animated ? "claude-line" : ""} 
          ...
          fill="#D97757" 
          style={!animated ? {transformOrigin: '50px 50px', transform: 'rotate(150deg) scaleY(1.39885) rotate(-150deg)'} : {}}
        />
        <path 
          className={animated ? "claude-line" : ""} 
          ...
          fill="#D97757" 
          style={!animated ? {transformOrigin: '50px 50px', transform: 'rotate(120deg) scaleY(1.39913) rotate(-120deg)'} : {}}
        />
        <path 
          className={animated ? "claude-line" : ""} 
          ...
          fill="#D97757" 
          style={!animated ? {transformOrigin: '50px 50px', transform: 'rotate(90deg) scaleY(1.39935) rotate(-90deg)'} : {}}
        />
        <path 
          className={animated ? "claude-line" : ""} 
          ...
          fill="#D97757" 
          style={!animated ? {transformOrigin: '50px 50px', transform: 'rotate(60deg) scaleY(1.39916) rotate(-60deg)'} : {}}
        />
        <path 
          className={animated ? "claude-line" : ""} 
          ...
          fill="#D97757" 
          style={!animated ? {transformOrigin: '50px 50px', transform: 'rotate(30deg) scaleY(1.39844) rotate(-30deg)'} : {}}
        />
        <path 
          className={animated ? "claude-line" : ""} 
          ...
          fill="#D97757" 
          style={!animated ? {transformOrigin: '50px 50px', transform: 'rotate(0deg) scaleY(1.39862) rotate(0deg)'} : {}}
        />
      </svg>
    </div>
  )
